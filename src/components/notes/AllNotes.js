...
import { getNotesByGolfer } from "../../managers/NoteManager"
...
export const AllNotes = () => {
    ...
    return (
        <div className="bg-cover bg-center relative w-full min-h-screen bg-gradient-to-tl from-green-800 to-blue-800">
            <div className="flex flex-col items-center justify-center md:p-20 py-10">
            ...
            <div className="flex flex-col items-center space-x-4 justify-center">
                <div className="flex items-center md:flex-row flex-col justify-center ">
                    <Tooltip
                        ...
                        placement="right"
                    >
                        <Card className="md:my-10 px-10 border  border-none rounded-lg bg-opacity-10 shadow-lg hover:bg-opacity-20 hover:scale-125 duration-200 " onClick={() => navigate("/addNote")}>
                ...
                <div className="flex flex-row flex-wrap items-center justify-center md:px-10 pr-3">
