...
export const AddMyClub = () => {
    ...
    return (
        <>
            {/* form to add a club to the user's bag */}
            <div className="bg-cover bg-center relative w-full min-h-screen bg-gradient-to-tl from-green-800 to-blue-800 py-20">
                <div className="flex flex-col items-center justify-center">
                    <Card className="px-10 border  border-none rounded-lg bg-opacity-10 shadow-lg hover:bg-opacity-20 md:scale-110 duration-200 bg-slate-400">
                        <div className="flex flex-col items-center justify-center">
