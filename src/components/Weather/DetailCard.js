...
export const DetailCard = ({ weather_icon, data }) => {
        ...
        <div>
            <div className="container p-4 flex items-center justify-center shadow-lg rounded-lg bg-white h-1/3 mb-auto">
                <div className="my-auto">
                    <p className="font-bold text-5xl text-pink-800 mb-2">{Math.round(main.temp)}&deg;F</p>
                    ...
                    <p className="tracking-wider">{moment().format("MMM Do YY")}</p>
                </div>
